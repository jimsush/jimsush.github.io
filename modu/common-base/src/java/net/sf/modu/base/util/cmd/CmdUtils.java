...
import net.sf.modu.base.exception.ExceptionUtils;
import net.sf.modu.base.exception.ModuException;
import net.sf.modu.base.util.cmd.impl.RunCmdService;
import net.sf.modu.base.util.format.MacAddrFormatter;
import net.sf.modu.base.util.sys.SysUtils;
...
public class CmdUtils {
    ...
    public static String getLocalHostName(){
        try {
            ...
            throw new ModuException(ModuException.INTERNAL_ERROR,e,info);
        }
    }
